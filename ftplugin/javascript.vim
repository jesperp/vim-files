...
iabbr for( for (●) {<cr>…<cr>}<C-O>?●<cr><C-O>x<C-R>=Eatchar('\s')<CR>
iabbr while( while (●) {<cr>…<cr>}<C-O>?●<cr><C-O>x<C-R>=Eatchar('\s')<CR>
iabbr if( if (●) {<cr>…<cr>}<C-O>?●<cr><C-O>x<C-R>=Eatchar('\s')<CR>
iabbr switch( switch (●) {<cr>case …: …<cr>default: …<cr>}<C-O>?●<cr><C-O>x<C-R>=Eatchar('\s')<CR>
iabbr do{ do {<cr>●<cr>} while (…)<C-O>?●<cr><C-O>x<C-R>=Eatchar('\s')<CR>
